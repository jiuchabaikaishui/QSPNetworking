#
#  Be sure to run `pod spec lint QSPNetworking.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "jiuchabaikaishui"
  # s.authors            = { "jiuchabaikaishui" => "781849568@qq.com" }
  # s.social_media_url   = "http://twitter.com/jiuchabaikaishui"
