...
typedef BOOL (^QSPConditionOfSuccessBolck)(id responseObject);
typedef void (^QSPCompletionBlock)(BOOL success, id responseObject, NSError *error);
typedef void (^QSPProgressBolck)(NSProgress * uploadProgress);

typedef void (^QSPNetworkingErrorBlock)(NSError *error, UIViewController *controller);
typedef void (^QSPDataErrorBlock)(id responseObject, UIViewController *controller);

typedef void (^QSPLoadBlock)(UIViewController *controller);
